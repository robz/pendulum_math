...
# Substitute symbols
thetaSymbol, thetaDotSymbol = symbols("theta thetaDot")
thetaDotDot = thetaDotDot.subs(
    [(Derivative(theta, t), thetaDotSymbol), (theta, thetaSymbol)]
)
